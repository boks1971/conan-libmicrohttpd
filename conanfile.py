...
class LibmicrohttpdConan(ConanFile):
	...
	# add gnutls and gcrypt install paths
        ...
        configure_command = "cd %s && %s ./configure --enable-static --enable-shared %s %s" % (self.ZIP_FOLDER_NAME, self.generic_env_configure_vars(), config_options_string, additional_opts)
